...
router.get('/listing/:id', handleGetOne);
router.post('/listing',checkJwt, permissions('create:listing'), handleCreate);
router.put('/listing/:id',checkJwt, permissions('update:listing'), handleUpdate);
router.delete('/listing/:id',checkJwt, permissions('delete:listing'), handleDelete);
